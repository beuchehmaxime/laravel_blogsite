        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              {{-- <img src="{{ (!empty($user->photo))? url('assets/img/adminimage/'.$user->photo) : url('https://via.placeholder.com/100x100')}}" alt="Profile" class="rounded-circle"> --}}
              <h2> {{$user->name}} </h2>
              <h3>{{$user->email}}</h3>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic"> {{$user->password}} </p>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form method="post" action="{{route('admin.profile.update')}}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input name="name" type="text" class="form-control @error('name')
                                is-invalid
                            @enderror" id="name" value="{{ $user->name}}"> <br>
                            @error('name')
                    ...
                    <div class="row mb-3">
                        <label for="name" class="col-md-4 col-lg-3 col-form-label">Phone Number</label>
                        <div class="col-md-8 col-lg-9">
                            <input name="name" type="text" class="form-control @error('phonenumber')
                                is-invalid
                            @enderror" id="name" value="{{ $user->phonenumber}}"> <br>
                            @error('phonenumber')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                          <input name="email" type="email" class="form-control @error('email')
                              is-invalid
                          @enderror" id="email" value="{{$user->email}}"> <br>
                          @error('email')
                                <p class="text-danger">{{ $message }}</p>
                          @enderror
                        </div>
