        ...
        <div class="row mb-5">
          ...
          <div class="d-md-flex post-entry-2 half">
            <a href="#" class="me-4 thumbnail">
              <img src="{{asset('assetss/img/post-landscape-2.jpg')}}" alt="" class="img-fluid">
            </a>
          ...
          <div class="d-md-flex post-entry-2 half mt-5 bg-light">
            <a href="#" class="me-4 thumbnail order-2">
              <img src="{{asset('assetss/img/post-landscape-1.jpg')}}" alt="" class="img-fluid">
            </a>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-lg-4 text-center mb-5">
            <img src="{{asset('assetss/img/person-1.jpg')}}" alt="" class="img-fluid rounded-circle w-50 mb-4">
            <h4>Cameron Williamson</h4>
            <span class="d-block mb-3 text-uppercase">Founder &amp; CEO</span>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, perspiciatis repellat maxime, adipisci non ipsam at itaque rerum vitae, necessitatibus nulla animi expedita cumque provident inventore? Voluptatum in tempora earum deleniti, culpa odit veniam, ea reiciendis sunt ullam temporibus aut!</p>
          </div>
          <div class="col-lg-4 text-center mb-5">
            <img src="{{asset('assetss/img/person-2.jpg')}}" alt="" class="img-fluid rounded-circle w-50 mb-4">
            <h4>Wade Warren</h4>
            <span class="d-block mb-3 text-uppercase">Founder, VP</span>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, perspiciatis repellat maxime, adipisci non ipsam at itaque rerum vitae, necessitatibus nulla animi expedita cumque provident inventore? Voluptatum in tempora earum deleniti, culpa odit veniam, ea reiciendis sunt ullam temporibus aut!</p>
          </div>
          <div class="col-lg-4 text-center mb-5">
            <img src="{{asset('assetss/img/person-3.jpg')}}" alt="" class="img-fluid rounded-circle w-50 mb-4">
            <h4>Jane Cooper</h4>
